...
/** Slick data model trait for extension, choice of backend or usage in the cake pattern. (Make sure to initialize this late.)
  ...
  */
trait Tables
    extends WorkSpacesTable with PlayEvolutionsTable with PostsTable
  ...
  lazy val schema: profile.SchemaDescription =
    BotClientInfo.schema ++ BotsPosts.schema ++ PlayEvolutions.schema ++ Posts.schema ++ WorkSpaces.schema
